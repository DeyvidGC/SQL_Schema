...
create table University(
    ...
    quantity_site int not null,
    type varchar(10) not null,
    location varchar(20) not null,
    quantity_students int not null,
    fundation_year date not null
);
...
create table Student(
	...
	constraint fk_university foreign key(id_university) references University(id_university),
